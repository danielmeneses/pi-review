/**
 * Header component for the Change Tracker.
 *
...
export function Header(props: HeaderProps): JSX.Element {
  ...
  return (
    <header>
      <h1>Change Tracker{pending > 0 && <span class="h1-badge" title={pending === 1 ? `There is 1 file awaiting review.` : `There are ${pending} files awaiting review.`}>{pending}</span>}</h1>
