...
export async function apiSendChat(message: string): Promise<{ success: boolean }> {
...
/** Poll for chat responses. */
export async function apiPollChatResponse(): Promise<Array<{ text: string; timestamp: number }>> {
